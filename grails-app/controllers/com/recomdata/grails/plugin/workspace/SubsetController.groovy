...
class SubsetController {
	...
	def query = {
		...
		render(plugin: 'transmart-workspace', template:'/subset/query', model:[query1:displayQuery1, query2:displayQuery2])
	}
	...
	def showSubsetPanels = {
		...
		render(plugin: 'transmart-workspace', template:'/subset/subsetPanel')
